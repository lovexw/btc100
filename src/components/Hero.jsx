    ...
    <section className="pt-32 pb-20 px-4 sm:px-6 lg:px-8">
      <div className="max-w-6xl mx-auto text-center">
        <h1 className="text-5xl sm:text-6xl lg:text-7xl font-bold mb-6 leading-tight text-gray-900">
          <span className="gradient-text">比特币的</span>
          <br />
          <span className="text-gray-800">百万美元之路</span>
        </h1>
        <p className="text-xl sm:text-2xl text-gray-600 max-w-3xl mx-auto mb-8 leading-relaxed">
          每一位长期持有者都相信同一个梦想——比特币终将达到 <span className="text-orange-500 font-semibold">100 万美元</span>。
          <br />
